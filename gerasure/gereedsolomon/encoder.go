...
// Encoder is a wrapper around [reedsolomon.Encoder] satisfying the [gerasure] interfaces.
type Encoder struct {
...
// Callers should assume that the Encoder takes ownership of data slice.

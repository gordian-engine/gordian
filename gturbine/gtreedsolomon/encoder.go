...
// Encoder is a wrapper around [reedsolomon.Encoder] satisfying the [gturbine] interfaces.
type Encoder struct {
...
// Encode satisfies [gturbine.Encoder].
// Callers should assume that the Encoder now owns the data slice.

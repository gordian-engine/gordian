...
// WithProposedHeaderInterceptor sets the proposed header interceptor
// for the engine, allowing observation and modification of the proposed header
// generated by the engine's state machine.
//
// Most applications will require this option,
// but the engine allows it to be omitted.
func WithProposedHeaderInterceptor(i tmelink.ProposedHeaderInterceptor) Opt {
	return func(_ *Engine, smc *tmstate.StateMachineConfig) error {
		smc.ProposedHeaderInterceptor = i
		return nil
	}
}
